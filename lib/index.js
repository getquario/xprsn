...
const DESCS = Object.getOwnPropertyDescriptors,
  ...
  // The two classes this module throws, keyed by prototype; `relocate` falls
  // back to plain Error for a diagnostic whose prototype a caller replaced.
  KINDS = new Map([
...
export let relocate = (diag, { prefix = "", offset = 0 } = {}) => {
  ...
  let d = /** @type {any} */ (diag),
    props = DESCS(d),
    copy = (KINDS.get(PROTO(d)) || Error)(prefix + d.message);
